...
public class OrdersFacade extends AbstractFacade<Orders> implements OrdersFacadeLocal {
    ...
    @Override
    public List<Orders> findLimit( int number ) {
        return em.createNamedQuery("Orders.findAll").setMaxResults(number).getResultList();
    }
    ...
    public Orders createAndReturn( Orders orders ) {
        em.persist( orders );
        return (Orders)em.createNamedQuery("Orders.findAll").setMaxResults(10).getResultList().get(0);
    }
