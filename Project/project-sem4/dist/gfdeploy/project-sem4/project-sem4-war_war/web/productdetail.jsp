                                ...
                                <div class="content_grid">
                                    <div class="col-md-9">
                                        ...
                                        <div class="cont1 span_2_of_a1 simpleCart_shelfItem">
                                            ...
                                            <p class="quick_desc">${productDetails.description}</p>

                                            <form style="margin-top: 20px" action="AddToCart?proId=${productDetails.PId}" method="post">
                                                <!--<input type="hidden" name="proId" value="${productDetails.PId}" />-->
                                                <ul class="product-qty">
                                                    <h2 class="quick">Quantity:</h2>
                                                    <input type="text" name="productQuantity" />
                                                </ul>
                                                <div class="">
                                                    <input type="submit" value="Add to Cart" title="" class="btn_form button item_add item_1 order">
                                                </div>
                                            </form>
                                        </div>
                                        <div class="clearfix"></div>
