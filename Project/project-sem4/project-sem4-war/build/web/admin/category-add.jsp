...
<html>
    ...
    <body class="w3-light-grey">
        ...
        <div class="w3-container">
            ...
            <h3>Add Category</h3>
            <form action="Category?action=checkAdd" method="post">
                <p>
                    <label>Name Category: </label>
                    <input class="w3-input w3-border w3-padding" type="text" name="name"  placeholder=" category name" />
                </p>
                <p>
                    <label>Name Brand: </label>
                    <input class="w3-input w3-border w3-padding" type="text" name="brand"  placeholder=" brand name" />
                </p>
                <p>
                    <label>Status: </label>
